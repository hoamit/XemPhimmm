...
function VideoPlayerInstance({ url, poster, onEnded, onError, onRetry }: VideoPlayerProps & { onRetry: () => void }) {
  ...
  return (
    ...
    >
      <video ref={videoRef} poster={poster} className="h-full w-full" onClick={togglePlay} playsInline />
      ...
      >
        <div className="flex items-center justify-between bg-gradient-to-b from-black/60 to-transparent p-4">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          ...
          {isError ? (
            <div className="pointer-events-auto rounded-[1.7rem] border border-primary/20 bg-black/88 p-8 text-center">
        ...
        <div className="space-y-4 p-4 md:p-6">
          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <button type="button" onClick={togglePlay} className="text-white transition-colors hover:text-primary">
